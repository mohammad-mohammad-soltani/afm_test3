                                ...
                                <div class="nk-editor">
                                    <div class="nk-editor-header">
                                        <div class="nk-editor-title">
                                            <h4 class="me-3 mb-0 line-clamp-1">صحبت با هوش مصنوعی بر اساس الگو</h4>
                                    ...
                                    <div class="nk-editor-main">
                                        <div class="nk-editor-base">
                                            <ul class="nav nav-tabs nav-sm nav-tabs-s1 px-3">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link " data-bs-toggle="tab" href="#AIsetting">تنظیمات مدل هوش مصنوعی</a>
                                                </li>
                                            ...
                                            <div class="tab-content mt-0">
                                                        ...
                                                        <div class="row gy-4 gx-4">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="form-label">پرامپت خود را انتخاب کنید</label>
                                                                    <div class="form-control-wrap">
                                                                        <select id="sel" class="form-select js-select2">
                                                                            <option value="n">وارد کردن پرامپت الزامی است</option>
                                                                            <option value="1">پرامپت اول</option>
                                                                            <option value="2">پرامپت دوم</option>
                                                                            <option value="3">پرامپت سوم</option>
                                                                            <option value="4">پرامپت چهارم</option>
                                                                            <option value="5">پرامپت پنجم</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div><!-- .col -->
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="form-label">اگر چیزی هست که میخواهید به پرامپت اظافه شود بنویسید</label>
                                                                    <div class="form-control-wrap">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label for="PrimaryKeywords" class="form-label">متغیر ها</label>
                                                                    <div class="form-control-wrap">
                                                                        <input id="num_1" dir="ltr" type="text" class="form-control" placeholder="[num_1]" />
                                                                        <br>
                                                                        <input id="num_2" dir="ltr" type="text" class="form-control" placeholder="[num_2]" />
                                                                    </div>
                                                                    <div class="form-note d-flex justify-content-between"><span>اختیاری</span><span>0/10</span></div>
                                                                </div>
                                                            </div><!-- .col -->
                                                ...
                                                <div class="tab-pane fade" id="AIsetting">
                                                    <form  class="px-3 py-3">
                                                        <div class="row gy-4 gx-4">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                               ...
                                                               <p>در اینجا شما میتوانید مدل هوش مصنوعی خود را بر اساس نیاز خود تغییر دهید تا بهترین بازخورد را داشته باشید</p>
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <select id="sel_ai" class="form-select js-select2" >
                                                                            ...
                                                                            <option value="1">GPT-4 : قدرت پاسخگویی بالا</option>
                                                                            <option value="2">GPT-3.5 turbo : سرعت بالا</option>
...
?>
    ...
    <script>
        ...
        function ajax_sender(message) {
            ...
            if (document.getElementById("sel").value == "n") {
    
                document.getElementById("answer").innerHTML = "لطفا پرامپت را وارد نمایید";
            }else{
            
                document.getElementById("answer").innerHTML = "درحال یافتن پاسخی مناسب برای شما...";
         new Promise((resolve, reject) => {
            
            $.get('<?php echo url."WEB_C/".$_SESSION["WEB_C"]."/AI"; ?>', { prampet: document.getElementById("sel").value,
        num_1: eval(document.getElementById("num_1").value),
        num_2: eval(document.getElementById("num_2").value),
        //solve_way : document.getElementById("num_2").value,
        added_text : document.getElementById("added_text").value,
        ai : document.getElementById("sel_ai").value,
 ...
 name: "پاسخ ایجاد شده با هوش مصنوعی",
 text: innerHtml,
 });
 });
    toastr.clear();
